...
func TestToUintE(t *testing.T) {
	...
	for i, test := range tests {
		...
		v, err := xcast.ToUintE(test.input)
		if test.iserr {
...
func TestToUint64E(t *testing.T) {
	...
	for i, test := range tests {
		...
		v, err := xcast.ToUint64E(test.input)
		if test.iserr {
			assert.Error(t, err, errmsg)
			continue
		}
...
func TestToUint32E(t *testing.T) {
	...
	for i, test := range tests {
		...
		v, err := xcast.ToUint32E(test.input)
		if test.iserr {
			assert.Error(t, err, errmsg)
			continue
		}
...
func TestToUint16E(t *testing.T) {
	...
	for i, test := range tests {
		...
		v, err := xcast.ToUint16E(test.input)
		if test.iserr {
			assert.Error(t, err, errmsg)
			continue
		}
...
func TestToUint8E(t *testing.T) {
	...
	for i, test := range tests {
		...
		v, err := xcast.ToUint8E(test.input)
		if test.iserr {
			assert.Error(t, err, errmsg)
			continue
		}
...
func TestToInt64E(t *testing.T) {
	...
	for i, test := range tests {
		...
		v, err := xcast.ToInt64E(test.input)
		if test.iserr {
			assert.Error(t, err, errmsg)
			continue
		}
...
func TestToInt32E(t *testing.T) {
	...
	for i, test := range tests {
		...
		v, err := xcast.ToInt32E(test.input)
		if test.iserr {
			assert.Error(t, err, errmsg)
			continue
		}
...
func TestToInt16E(t *testing.T) {
	...
	for i, test := range tests {
		...
		v, err := xcast.ToInt16E(test.input)
		if test.iserr {
			assert.Error(t, err, errmsg)
			continue
		}
...
func TestToInt8E(t *testing.T) {
	...
	for i, test := range tests {
		...
		v, err := xcast.ToInt8E(test.input)
		if test.iserr {
			assert.Error(t, err, errmsg)
			continue
		}
...
func TestToFloat64E(t *testing.T) {
	...
	for i, test := range tests {
		...
		v, err := xcast.ToFloat64E(test.input)
		if test.iserr {
			assert.Error(t, err, errmsg)
			continue
		}
...
func TestToFloat32E(t *testing.T) {
	...
	for i, test := range tests {
		...
		v, err := xcast.ToFloat32E(test.input)
		if test.iserr {
			assert.Error(t, err, errmsg)
			continue
		}
...
func TestToStringE(t *testing.T) {
	...
	for i, test := range tests {
		...
		v, err := xcast.ToStringE(test.input)
		if test.iserr {
			assert.Error(t, err, errmsg)
			continue
		}
...
func TestStringerToString(t *testing.T) {
	var x foo
	x.val = "bar"
	assert.Equal(t, "bar", xcast.ToString(x))
}
...
func TestStringMapStringSliceE(t *testing.T) {
	...
	for i, test := range tests {
		...
		v, err := xcast.ToStringMapStringSliceE(test.input)
		if test.iserr {
			assert.Error(t, err, errmsg)
			continue
		}
		...
		// Non-E test
		v = xcast.ToStringMapStringSlice(test.input)
		assert.Equal(t, test.expect, v, errmsg)
	}
}
...
func TestToStringMapE(t *testing.T) {
	...
	for i, test := range tests {
		...
		v, err := xcast.ToStringMapE(test.input)
		if test.iserr {
			assert.Error(t, err, errmsg)
			continue
		}
		...
		// Non-E test
		v = xcast.ToStringMap(test.input)
		assert.Equal(t, test.expect, v, errmsg)
	}
}
...
func TestToStringMapBoolE(t *testing.T) {
	...
	for i, test := range tests {
		...
		v, err := xcast.ToStringMapBoolE(test.input)
		if test.iserr {
			assert.Error(t, err, errmsg)
			continue
		}
		...
		// Non-E test
		v = xcast.ToStringMapBool(test.input)
		assert.Equal(t, test.expect, v, errmsg)
	}
}
...
func TestToStringMapIntE(t *testing.T) {
	...
	for i, test := range tests {
		...
		v, err := xcast.ToStringMapIntE(test.input)
		if test.iserr {
			assert.Error(t, err, errmsg)
			continue
		}
		...
		// Non-E test
		v = xcast.ToStringMapInt(test.input)
		assert.Equal(t, test.expect, v, errmsg)
	}
}
...
func TestToStringMapInt64E(t *testing.T) {
	...
	for i, test := range tests {
		...
		v, err := xcast.ToStringMapInt64E(test.input)
		if test.iserr {
			assert.Error(t, err, errmsg)
			continue
		}
		...
		// Non-E test
		v = xcast.ToStringMapInt64(test.input)
		assert.Equal(t, test.expect, v, errmsg)
	}
}
...
func TestToStringMapStringE(t *testing.T) {
	...
	for i, test := range tests {
		...
		v, err := xcast.ToStringMapStringE(test.input)
		if test.iserr {
			assert.Error(t, err, errmsg)
			continue
		}
		...
		// Non-E test
		v = xcast.ToStringMapString(test.input)
		assert.Equal(t, test.expect, v, errmsg)
	}
}
...
func TestToBoolSliceE(t *testing.T) {
	...
	for i, test := range tests {
		...
		v, err := xcast.ToBoolSliceE(test.input)
		if test.iserr {
			assert.Error(t, err, errmsg)
			continue
		}
		...
		// Non-E test
		v = xcast.ToBoolSlice(test.input)
		assert.Equal(t, test.expect, v, errmsg)
	}
}
...
func TestToIntSliceE(t *testing.T) {
	...
	for i, test := range tests {
		...
		v, err := xcast.ToIntSliceE(test.input)
		if test.iserr {
			assert.Error(t, err, errmsg)
			continue
		}
...
func TestToSliceE(t *testing.T) {
	...
	for i, test := range tests {
		...
		v, err := xcast.ToSliceE(test.input)
		if test.iserr {
			assert.Error(t, err, errmsg)
			continue
		}
...
func TestToStringSliceE(t *testing.T) {
	...
	for i, test := range tests {
		...
		v, err := xcast.ToStringSliceE(test.input)
		if test.iserr {
			assert.Error(t, err, errmsg)
			continue
		}
		...
		// Non-E test
		v = xcast.ToStringSlice(test.input)
		assert.Equal(t, test.expect, v, errmsg)
	}
}
...
func TestToDurationSliceE(t *testing.T) {
	...
	for i, test := range tests {
		...
		v, err := xcast.ToDurationSliceE(test.input)
		if test.iserr {
			assert.Error(t, err, errmsg)
			continue
		}
		...
		// Non-E test
		v = xcast.ToDurationSlice(test.input)
		assert.Equal(t, test.expect, v, errmsg)
	}
}
...
func TestToBoolE(t *testing.T) {
	...
	for i, test := range tests {
		...
		v, err := xcast.ToBoolE(test.input)
		if test.iserr {
			assert.Error(t, err, errmsg)
			continue
		}
...
func TestIndirectPointers(t *testing.T) {
	...
	assert.Equal(t, xcast.ToInt(y), 13)
	assert.Equal(t, xcast.ToInt(z), 13)
}
...
func TestToTimeEE(t *testing.T) {
	...
	for i, test := range tests {
		...
		v, err := xcast.ToTimeE(test.input)
		if test.iserr {
			assert.Error(t, err, errmsg)
			continue
		}
...
func TestToDurationE(t *testing.T) {
	...
	for i, test := range tests {
		...
		v, err := xcast.ToDurationE(test.input)
		if test.iserr {
			assert.Error(t, err, errmsg)
			continue
		}
